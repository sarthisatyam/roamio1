...
const JourneyPage: React.FC<JourneyPageProps> = ({ onNavigateToAccount, externalActivities = [] }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-background">
      {/* HEADER */}
      <div className="px-4 py-4 bg-gradient-hero">
        ...
        {filteredActivities.map((activity, index) => {
          ...
          return (
            <Card
              ...
              className={cn(
                "p-3 rounded-2xl shadow-soft transition cursor-pointer hover:shadow-medium",
            ...
            >
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  <h4 className={cn("font-semibold", isCompleted && "line-through")}>{activity.title}</h4>
